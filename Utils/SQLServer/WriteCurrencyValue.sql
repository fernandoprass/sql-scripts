-- =====================================================================
-- Author: Fernando Prass | Create date: 10/12/2013
-- Language: T-SQL for SQL Server 2010+
-- Description: Write the currency value in words (in Portuguese). Ex: 1978 -> Um Mil e Novecentos e Setenta e Oito Reais 
-- Contact: https://github.com/fernandoprass or https://twitter.com/oFernandoPrass
-- =====================================================================

CREATE FUNCTION dbo.fcWriteCurrencyValue
   (@valor numeric(18,2))
RETURNS VARCHAR(8000)
AS
BEGIN
   DECLARE @negativo varchar(20), @valorCentavos TINYINT, @valorInt BIGINT, @valorStr VARCHAR(20), @pedacoStr1 VARCHAR(20)
         , @pedacoStr2 VARCHAR(20), @pedacoStr3 VARCHAR(20), @pedacoInt1 INT, @pedacoInt2 INT, @pedacoInt3 INT, @menorN INT
   ...
   INSERT INTO @numeros VALUES('Tr�s', 3, 3)
   ...
   INSERT INTO @milhar VALUES('Milh�o', 'Milh�es', 7, 9)
   INSERT INTO @milhar VALUES('Bilh�o', 'Bilh�es', 10, 12)
   INSERT INTO @milhar VALUES('Trilh�o', 'Trilh�es', 13, 15)
   INSERT INTO @milhar VALUES('Quadrilh�o', 'Quadrilh�es', 16, 18)

   --Busca o n�mero de casas (sempre em 3)
   ...
   --Define a descri��o (N�o coloca se n�o tiver reais)
